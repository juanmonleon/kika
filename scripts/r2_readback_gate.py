...
def main():
    """The gate. Behind a function because `test_deploy_smoke` requires every
    script in this directory to IMPORT without doing work -- and this one parsed
    arguments at module level, so importing it exited with argparse's SystemExit
    instead of raising anything a reader would recognise.
    """
