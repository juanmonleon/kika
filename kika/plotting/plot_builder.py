...
class PlotBuilder:
    ...
    # The heatmap drawing itself lives in :class:`~kika.plotting.heatmap_builder.HeatmapBuilder`.
    # It moved there in January 2026, and ``_build_heatmap`` above has delegated to it ever
    # since; the copies of the tick, block-boundary and uncertainty-panel helpers that stayed
    # behind here were called by nothing but each other, and were removed in September 2026.
